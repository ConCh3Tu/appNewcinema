<?php
	$page_title = "Panel Genero";	
	$script_name= "script/v1/genero_config.js?v=1.0";
						...
						<div class="menu-body">
							<nav>
								<ul>
									...
									<li data-id="_3">
										<a class="article-me" data-name="ajax-nav" href="genero.php" id="l_3"><i class="fa fa-group"></i> <span>Genero</span></a></li>
							...
							<section class="panel-default">
								<div class="row no-gutters">
									<div class="col-md-3">
										...
										<form name="g-form" id="g-form" class="form-control h-100 d-inline-block">
											<div class="form-group registro-form" id="g0" >
												<label for="g-genero" class="col-form-label-sm">Tipo genero <b class="text-danger">*</b></label>
												<input type="text" name="g-genero" id="g-genero" data-id="0" class="form-control" autofocus="true">
												<input type="text" hidden name="g-key"  id="g-key" class="form-control" >
											</div>		
											<div class="form-group">
												<label for="g-detalle" class="col-form-label-sm">Descripción</label>
												<textarea rows="5" class="form-control" name="g-detalle" id="g-detalle" placeholder="..."></textarea>
											</div>
											<div class="modal-footer modal-footer-secundary modal-footer-pad-15">

                    							<button type="button" id="g-btnSave" class="btn btn-primary"><i class="fa fa-save fa-1x fa-fw"></i>Guardar</button>
                    							<button type="button" id="g-btnCancel" class="btn btn-danger hid"><i class="fa fa-close fa-1x fa-fw"></i>Cancelar</button>
                    							<button type="button" id="g-btnUpdate" class="btn btn-success hid"><i class="fa fa-edit fa-1x fa-fw"></i>Modificar</button>
											</div>
									...
									<div class="col-md-9">
                						<fieldset class="form-control h-100 d-inline-block">
											<p class="lead">Listar Genero</p>
 											<form method="post" id="form-search">
												<div class="row">
													<div class="col-lg-6"></div>
													<div class="col-lg-6">
														<div class="input-group">
															<input type="search" class="form-control" placeholder="Buscar..." aria-label="Buscar..." id="g-search" name="g-search">
															<span class="input-group-btn">
															<button class="btn btn-primary" id="g-btnSearch" type="button">Go!</button>
															</span>
														</div>
													</div>
												</div>
											...
											<div class="text-center text-secondary" id="sin-r" style="display: none;">
												<small>Sin registro a mostrar</small>
											</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body text-center">
					<form name="md-form" id="mg-form">
						...
						<button type="button" id="g-btnDelete" class="btn btn-danger"><i class="fa fa-check"></i> Confirmar</button>					
					</form>
				</div>
